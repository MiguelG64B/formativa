        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" method="post" action="./php/verificartoken.php">
                <div class="form-group">
                  <input type="number" class="form-control form-control-lg" name="codigo" placeholder="Codigo">
                </div>
                ...
                <div class="mt-3">
                  <button type="submit" class="text-center btn btn-primary btn-block">Verificar</button>
                </div>
              </form>
              <?php
              if (isset($_GET['error'])) {
