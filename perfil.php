                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="./php/editarperfil.php" method="post">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Nombre" name="nombre" placeholder="<?php echo $arregloUsuario['nombre']; ?>" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Apellido</label>
                      <input type="text" class="form-control" id="apellido" name="apellido" placeholder="<?php echo $arregloUsuario['apellido']; ?>"required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputName1">Telefono</label>
                      <input type="number" class="form-control" id="telefono" name="telefono" placeholder="<?php echo $arregloUsuario['telefono']; ?>"required>
                    </div>
