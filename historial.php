        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-12 grid-margin stretch-card">
                    ...
                    <div class="card-body">
                      <div class="d-sm-flex justify-content-between align-items-start">
                        <div>
                          ...
                          <p class="card-subtitle card-subtitle-dash">Historial de partidos en los estuviste inscrito</p>
                        </div>
                      </div>
              ...
              if (isset($_GET['limite'])) {
                if ($_GET['limite'] > 0) {
                  echo ' <li><a href="historial.php?limite=' . ($_GET['limite'] - $_GET['limite']) . '">&lt;</a></li>';
                }
              }

              for ($k = 0; $k < $totalBotones; $k++) {
                echo  '<li><a href="historial.php?limite=' . ($k * 10) . '">' . ($k + 1) . '</a></li>';
              }
              if (isset($_GET['limite'])) {
                if ($_GET['limite'] + 6 < $totalBotones * $_GET['limite']) {
                  echo ' <li><a href="historial.php?limite=' . ($_GET['limite'] + 10) . '">&gt;</a></li>';
                }
              } else {
                echo ' <li><a href="historial.php?limite=10">&gt;</a></li>';
              }
              ?>
              </div>
            </div>
