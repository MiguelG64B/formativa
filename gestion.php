                    ...
                    <div class="card card-rounded">
                      <div class="card-body">
                            ...
                            <table class="table select-table">
                              <tbody>
                                <tr>
                                  ...
                                  <td>
                                  <a href="reporte.php?id=<?php echo $fila['id']; ?>" class="btn btn-primary text-white me-0">Finalizar</a>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                        ...
                        <?php
                            if (isset($_GET['limite'])) {
                              if ($_GET['limite'] > 0) {
                                echo '<button type="button" class="btn btn-inverse-primary"><a href="gestion.php?limite=' . ($_GET['limite'] - $_GET['limite']) . '">&lt;</a></button>';
                              }
                            }
                            for ($k = 0; $k < $totalBotones; $k++) {
                              echo  '<button type="button" class="btn btn-inverse-primary"><a href="gestion.php?limite=' . ($k * 3) . '">' . ($k + 1) . '</a></button>';
                            }
                            if (isset($_GET['limite'])) {
                              if ($_GET['limite'] + 6 < $totalBotones * $_GET['limite']) {
                                echo '<button type="button" class="btn btn-inverse-primary"><a href="gestion.php?limite=' . ($_GET['limite'] + 3) . '">&gt;</a></button>';
                              }
                            } else {
                              echo '<button type="button" class="btn btn-inverse-primary"><a href="gestion.php?limite=3">&gt;</a></button>';
                            }
                            ?>
                      </div>
                    </div>
